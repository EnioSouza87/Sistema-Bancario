...
namespace Banco_Sul
{
    public partial class RelatorioCliente : Form
    {
        ...
        private void BTN_RelatorioClienteBuscar_Click(object sender, EventArgs e)
        {
            ...
            {
                conexao.Open();
                cliente.IdCliente = Convert.ToInt32(NUMBOX_RelatorioCliente.Value);
                ...
                if (reader.Read())
                {
                    ...
                    TXTBOX_RelatorioNome.Text = Convert.ToString(reader[1]);
        ...
        private void BTN_RelatorioClienteLimpar_Click(object sender, EventArgs e)
        {
            ...
            if (opcao == DialogResult.Yes)
            {
                ...
                NUMBOX_RelatorioCliente.Value = 0;
