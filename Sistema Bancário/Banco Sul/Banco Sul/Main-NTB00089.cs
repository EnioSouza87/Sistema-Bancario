...
namespace Banco_Sul
{
    public partial class Main : Form
    {
        ...
        {
            RelatorioTodosClientes janelaRelatorioTodosClientes = new RelatorioTodosClientes();
            janelaRelatorioTodosClientes.MdiParent = this;
            janelaRelatorioTodosClientes.Show();
            janelaRelatorioTodosClientes.Location = new Point(0,0);
        }
    }
}
